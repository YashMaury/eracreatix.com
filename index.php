                                ...
                                <div class="t4s-coll-img t4s-pr" data-cacl-slide>
                                    ...
                                    <a class="t4s_cat_item_link t4s-img-wrap t4s-d-block" href="collections.php?cid=<?php echo $row['id']; ?>" target="_self">
                                        <div class="t4s_ratio t4s-bg-11" style="--aspect-ratioapt: 1.0;background: url(cdn/shop/collections/buy-product-title-at-vaaree-online_d4251e91-8e08-4929-b0ec-89c57eb7aa9ccd26.jpg?v=1710244392&amp;width=1); ">
                                            <img src="<?php echo "admin/uploads/category/" . $row['categoryImage']; ?>" width="800" height="800" alt="Buy <?php echo $row['categoryName']; ?> at Decor We , best home decor store in India">
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div class="t4s-product-wrapper">
                                <div class="t4s-product-inner t4s-pr t4s-oh">
                                    <div class="t4s-product-img t4s_ratio">
                                        <img class="t4s-product-main-img" src="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" width="800" height="800" alt="Buy <?php echo htmlentities($row['productName']); ?> | Decor We ">
                                    </div>
                                    ...
                                    <div class="t4s-product-info__inner">
                                        ...
                                        <?php if ($row['productAvailability'] == 'In Stock') { ?>
                                            <div class="text-center">
                                                <a href="products.php?pid=<?= $row['id']; ?>" class="t4s-product-form__submit t4s-btn t4s-btn-style-default 
