...
<main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
    ...
    <section id="shopify-section-template--16885348368630__main" class="shopify-section t4s-section t4s-section-customers">
        ...
        <script defer="" src="//vaaree.com/cdn/shop/t/130/assets/customer.min.js?v=31811728153001952421695367404"></script>
            ...
            <div class="t4s-col-12 t4s-account-content t4s-text-center">
                ...
                <div data-address="">
                    ...
                    <div id="AddAddress" class="add-form" style="display: none">
                        ...
                        <form method="post" action="/account/addresses" id="address_form_new" accept-charset="UTF-8" aria-labelledby="AddressNewHeading" class="t4s-container"><input type="hidden" name="form_type" value="customer_address"><input type="hidden" name="utf8" value="✓">
                            <div class="t4s_field t4s-pr">
                                <input class="t4s_frm_input" type="text" id="AddressCompanyNew" name="address[company]" value="" autocomplete="organization" placeholder="Address Name">
                                <label for="AddressCompanyNew">Address Name</label>
                            </div>
                            <div class="t4s_field t4s-pr">
                                <input class="t4s_frm_input" type="text" id="AddressFirstNameNew" name="address[first_name]" value="" autocomplete="given-name" placeholder="Full Name">
                                <label for="AddressFirstNameNew">Full Name</label>
                            </div>

                            <div class="t4s_field t4s-pr">
                                <input class="t4s_frm_input" type="tel" id="AddressPhoneNew" name="address[phone]" value="" autocomplete="tel" placeholder="Phone">
                                <label for="AddressPhoneNew">Phone</label>
                            </div>
                            <div class="t4s_field t4s-pr">
                                <input class="t4s_frm_input" type="text" id="AddressZipNew" name="address[zip]" value="" autocapitalize="characters" autocomplete="postal-code" placeholder="Pin Code">
                                <label for="AddressZipNew">Pin Code</label>
                            </div>
                            <div class="t4s_field t4s-pr">
                                <input class="t4s_frm_input" type="text" id="AddressAddress1New" name="address[address1]" value="" autocomplete="address-line1" placeholder="Address">
                                <label for="AddressAddress1New">Address</label>
                            </div>
                            <div class="t4s_field t4s-pr">
                                <input class="t4s_frm_input" type="text" id="AddressAddress2New" name="address[address2]" value="" autocomplete="address-line2" placeholder="Apartment, Flat, House Number">
                                <label for="AddressAddress2New">Apartment, Flat, House Number</label>
                            </div>
                            <div class="t4s_field t4s-pr">
                                <input class="t4s_frm_input" type="text" id="AddressCityNew" name="address[city]" value="" autocomplete="address-level2" placeholder="City">
                            ...
                            <div id="AddressProvinceContainerNew" style="" class="select-addr-label top-space">
                                ...
                                <div class="select">
                                    <select id="AddressProvinceNew" name="address[province]" data-default="" autocomplete="address-level1">
              ...
              -->
                            ...
                            <div class="select-addr-label top-space">
                                ...
                                <div class="select">
                                    <select id="AddressCountryNew" name="address[country]" data-default="" autocomplete="country">
              ...
              -->
                            ...
                            <div class="customer-sticky-wrapper save-address">
                                <button class="t4s_btn_black customer-sticky-button" id="save-address">
                                    Save Address
                                </button>
                            </div>
                        </form>
                ...
                <ul role="list" class="address-list t4s-container">
                    ...
                    <div class="customer-sticky-wrapper add-new-address desktop-addr-button" id="desktop_address_button">
                        ...
                        <div id="NoAddress" class="no-address-desktop-container">
                            ...
                            <div class="subheading">Add your address and get your favorite Vaaree products right to your doorstep!</div>
                            <div class="add-btn">
                                <button class="t4s_btn_black customer-sticky-button add-address-default" type="button" id="add-address">
                                    Add Address
                                </button>
                            </div>
                        </div>
