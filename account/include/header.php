...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" type="image/png" sizes="152x152" href="../media/favicon.jpeg">
    <title>Buy Best Home Decor Items &amp; Essentials Online At Best Prices &ndash; Decor We</title>
    <meta name="description" content="Home Décor- Buy Home Decorative Items &amp; essentials Online in India. Choose from a wide range of premium home decor products at Decor We. Buy house decoration items online at best prices.">
    <meta name="keywords" content="buy home decor, bedsheets, towels, kitchen, mugs online" />
    <meta name="author" content="House of Decor We">

    <meta property="og:site_name" content="Decor We">
    <meta property="og:url" content="https://Decor We.com/">
    ...
    <meta name="twitter:description" content="Home Décor- Buy Home Decorative Items &amp; essentials Online in India. Choose from a wide range of premium home decor products at Decor We. Buy house decoration items online at best prices.">
...
<body class="template-index ">
    ...
    <div class="t4s-website-wrapper">
        ...
        <h2 class="site-header__logo t4s-d-none">Decor We</h2>
                                ...
                                <div class="t4s-site-nav__icons t4s-use__kalles is--hover2 t4s-h-cart__design1 t4s-lh-1 t4s-d-inline-flex t4s-align-items-center">
                                    <?php if (isset($_SESSION['login'])) { ?>
                                        <div class="t4s-site-nav__icon t4s-site-nav__account t4s-pr t4s-d-none t4s-d-lg-inline-block">
                                            <a class="t4s-pr" href="dashboard.php">
                                        ...
                                        <div class="t4s-site-nav__icon t4s-site-nav__account t4s-pr t4s-d-none t4s-d-lg-inline-block">
                                            <a class="t4s-pr" href="logout.php">
                        ...
                        <div class="t4s-row t4s-g-0 t4s-align-items-center">
                            ...
                            <div class="t4s-col-3 t4s-text-end t4s-col-item t4s-h-cat__html t4s-rte">
                                <div class="return">
                                    ...
                                    <a class="cg" href="mailto:decorwe@gmail.com">decorwe@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (isset($_SESSION['login'])) { ?>
                        <li id="account-menu" class="t4s-menu-item t4s-item-level-0 t4s-menu-item-btns t4s-menu-item-acount t4s-menu-item-has-children t4s-only_icon_false">
                            ...
                            <ul id="account-submenu" class="t4s-sub-menu" style="display: none;">
                                ...
                                <li><a href="logout.php" data-no-instant="">Logout</a></li>
                            </ul>
                        </li>
                        <script>
