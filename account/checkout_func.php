...
if (isset($_POST['submit'])) {
    if (!isset($_SESSION['login'])) {
        ...
        if ($_POST['form_type'] == "place_order") {
            ...
            $fetch_cart = mysqli_fetch_array($cart);
            if (isset($_POST['save'])) {
                mysqli_query($con, "insert into address (user_id,for_order,mobile_no,shippingName,shippingAddress,shippingCity,shippingPincode,shippingState,shippingCountry,billingName,billingAddress,billingCity,billingPincode,billingState,billingCountry,status,regDate) values ('" . $_SESSION['id'] . "',null,'" . $_POST['mobile_no'] . "','" . $_POST['shippingName'] . "','" . $_POST['shippingAddress'] . "','" . $_POST['shippingCity'] . "','" . $_POST['shippingPincode'] . "','" . $_POST['shippingState'] . "','" . $_POST['shippingCountry'] . "','" . $_POST['billingName'] . "','" . $_POST['billingAddress'] . "','" . $_POST['billingCity'] . "','" . $_POST['billingPincode'] . "','" . $_POST['billingState'] . "','" . $_POST['billingCountry'] . "','0','" . date("Y-m-d h:i:s") . "')");
            }
            mysqli_query($con, "insert into address (user_id,for_order,mobile_no,shippingName,shippingAddress,shippingCity,shippingPincode,shippingState,shippingCountry,billingName,billingAddress,billingCity,billingPincode,billingState,billingCountry,status,regDate) values ('" . $_SESSION['id'] . "','" . $order_id . "','" . $_POST['mobile_no'] . "','" . $_POST['shippingName'] . "','" . $_POST['shippingAddress'] . "','" . $_POST['shippingCity'] . "','" . $_POST['shippingPincode'] . "','" . $_POST['shippingState'] . "','" . $_POST['shippingCountry'] . "','" . $_POST['billingName'] . "','" . $_POST['billingAddress'] . "','" . $_POST['billingCity'] . "','" . $_POST['billingPincode'] . "','" . $_POST['billingState'] . "','" . $_POST['billingCountry'] . "','0','" . date("Y-m-d h:i:s") . "')");
