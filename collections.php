                                ...
                                <div class="t4s-coll-img t4s-pr" data-cacl-slide>
                                    ...
                                    <a class="t4s_cat_item_link t4s-img-wrap t4s-d-block" href="collections.php?cid=<?php echo $row['id']; ?>" target="_self">
                                        <div class="t4s_ratio t4s-bg-11" style="--aspect-ratioapt: 1.0;background: url(cdn/shop/collections/buy-product-title-at-vaaree-online_d4251e91-8e08-4929-b0ec-89c57eb7aa9ccd26.jpg?v=1710244392&amp;width=1); ">
                                            <img src="<?php echo "admin/uploads/subcategory/" . $row['subcategoryImage']; ?>" width="800" height="800" alt="Buy <?php echo $row['subcategory']; ?> at Decor We , best home decor store in India">
                                        </div>
                                    </a>
                                </div>
                                        ...
                                        <div class="t4s-product-wrapper">
                                            <div class="t4s-product-inner t4s-pr t4s-oh">
                                                <div class="t4s-product-img t4s_ratio" data-style="--aspect-ratioapt: 1.0">
                                                    ...
                                                    <img class="t4s-product-main-img" src="admin/productimages/<?php echo htmlentities($products['id']); ?>/<?php echo htmlentities($products['productImage1']); ?>" width="800" height="800" alt="Buy <?php echo htmlentities($row['productName']); ?> Decor We online | Beautiful Cocktail Tools Set to choose from">
