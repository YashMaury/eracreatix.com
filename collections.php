...
if (isset($_GET['cid'])) {
    $page_category = mysqli_query($con, "select * from category where `id`='" . $_GET['cid'] . "'");
    if (isset($_GET['page'])) {
        $page = $_GET['page'];
    ...
    $page_category = mysqli_query($con, "select * from subcategory where `id`='" . $_GET['scid'] . "'");
    if (isset($_GET['page'])) {
        $page = $_GET['page'];
        $ret = mysqli_query($con, "select * from products where `subCategory` = '" . $_GET['scid'] . "' limit " . $_GET['page'] * 2);
    } else {
        $page = 1;
        $ret = mysqli_query($con, "select * from products where `subCategory` = '" . $_GET['scid'] . "' limit 2");
    }
}
...
<main id="MainContent" class="content-for-layout focus-none" role="main" tabindex="-1">
    <div id="shopify-section-template--16885348434166__41e67383-d98d-47ec-a5d4-87e556f2840d"
        class="shopify-section t4s-container t4s-heading-container">
        ...
        <div>
            <div class="collection-heading-container">
                <div class="collection-heading-introduction">
                    ...
                    <div class="collection-description">Grab our varied products styles and design and slumber like a
                        champion.</div>
                </div>
    ...
    <div id="shopify-section-template--16885348434166__0db95a41-2b33-4aee-a91e-f1355720fe38" class="shopify-section">
        ...
        <link rel="stylesheet" href="cdn/shop/t/130/assets/collection-banner-with-slider-common.aio.min.css"
            media="all">
                            ...
                            <div class="t4s-cat-content t4s-source-image t4s-eff t4s-eff-none t4s-eff-img-none t4s-text-center t4s-pr t4s-oh"
                                ...
                                <div class="t4s-coll-img t4s-pr" data-cacl-slide>
                                    ...
                                    <a class="t4s_cat_item_link t4s-img-wrap t4s-d-block"
                                        href="collections.php?scid=<?php echo $row['id']; ?>" target="_self">
                                        <div class="t4s_ratio t4s-bg-11"
                                            ...
                                            <img src="<?php echo "admin/uploads/subcategory/" . $row['subcategoryImage']; ?>"
                                                width="800" height="800"
                                                alt="Buy <?php echo $row['subcategory']; ?> at Decor We , best store in India">
                                        </div>
                                    </a>
                                </div>
                                <div class="t4s-cate-wrapper">
                                    <a class="t4s-cat-title" href="collections.php?scid=<?php echo $row['id']; ?>"
                                        target="_self">
    ...
    <section id="shopify-section-template--16885348434166__8c4f56e8-411a-4a0d-9354-cacd75a338f3"
        class="shopify-section t4s-section t4s-section-all t4s_tp_cdt t4s_tp_cd t4s_tp_istope t4s-banner">
        <!-- section/banner.liquid -->
        <div class="t4s-section-inner t4s_nt_se_template--16885348434166__8c4f56e8-411a-4a0d-9354-cacd75a338f3 t4s_se_template--16885348434166__8c4f56e8-411a-4a0d-9354-cacd75a338f3 t4s-container-wrap "
            ...
            <div class="t4s-container">
                <div class="t4s-banner-holder isotopet4s t4s_position_8 t4s_cover t4s-equal-height-false t4s-row t4s-gx-md-30 t4s-gy-md-30 t4s-gx-10 t4s-gy-10 isotopet4s-enabled"
                    data-isotopet4s-js="{ &quot;itemSelector&quot;: &quot;.t4s-banner-wrap&quot;, &quot;layoutMode&quot;: &quot;packery&quot; }"
                    style="position: relative; height: 0px;"></div>
            </div>
        </div>
    </section>
    <div id="shopify-section-template--16885348434166__70870fb9-5b83-4cf6-ac46-548496a84657"
        class="shopify-section t4s-container">
        <style>
            .horizontal_divider {
                margin-top: 2px;
                margin-bottom: 2px;
    ...
    <section id="shopify-section-template--16885348434166__main"
        class="shopify-section t4s-section t4s-section-main t4s-collection-page t4s_bk_flickity t4s_tp_istope t4s_tp_countdown">
        <!-- sections/main-collection.liquid -->

        <link href="cdn/shop/t/130/assets/collection-pages.aio.min.css?v=8013305485271043971711313785" rel="stylesheet"
            type="text/css" media="all">

        <link href="cdn/shop/t/130/assets/collection-products-list.aio.min.css?v=63705346789784507521703745383"
            rel="stylesheet" type="text/css" media="all">
        <link href="cdn/shop/t/130/assets/pagination.aio.min.css?v=136667778103927277341703745401" rel="stylesheet"
            type="text/css" media="all">

        <div class="t4s-section-inner t4s_nt_se_template--16885348434166__main t4s_se_template--16885348434166__main t4s-se-container "
            style="--bg-color: ;--bg-gradient: ;--border-cl: ;--mg-top: ;--mg-right: auto;--mg-bottom: 50px;--mg-left:auto;--pd-top: ;--pd-right: ;--pd-bottom: ;--pd-left: ;--mgtb-top: ;--mgtb-right: auto;--mgtb-bottom: 50px;--mgtb-left: auto;--pdtb-top: ;--pdtb-right: ;--pdtb-bottom: ;--pdtb-left: ;--mgmb-top: ;--mgmb-right: auto;--mgmb-bottom: 20px;--mgmb-left: auto;--pdmb-top: ;--pdmb-right: ;--pdmb-bottom: ;--pdmb-left: ;">
            <div class="t4s-container t4s-plp">
                <h2 class="hide collection--title" style="display:none"><?= $page_category_row['categoryName']; ?></h2>
                <div class="t4s-container-inner  ">
                    <div
                        class="t4s-collection-header t4s-d-flex 4s-align-items-center t4s-collection-header-plp sticky-filter-sort-container">

                        <div class="t4s-btn-filter-wrapper t4s-btn-filter-wrapper-button">
                            <button data-btn-as-a="" class="t4s-btn-filter"
                        ...
                        <link rel="stylesheet"
                            href="cdn/shop/t/130/assets/base_drop.min.css?v=126664663891124449391695367402" media="all">
                        <div class="collection-filter__label-button">
                            <div class="t4s-dropdown t4s-dropdown__sortby">
                                <div class="sort_by_hidden" data-id="t4s__sortby">
                                    <span class="t4s-d-none t4s-d-md-block" style="display:none!important">
                                        Featured
                                    </span>
                                    <span class="t4s-d-mobile-none t4s-d-none t4s-d-md-block">
                                        Sort
                                    </span>
                                ...
                                <div data-dropdown-wrapper="" class="t4s-dropdown__wrapper mm-sort-box t4s-drawer"
                                    id="t4s__sortby">
                                    ...
                                    <div class="t4s-dropdown__content">
                                        <div class="sort-by-radio  is--selected ">
                                            <input type="checkbox" id="myCheckbox__1" class="t4s-checkbox-wrapper"
                                                name="sort option" checked="">
                                            <label for="myCheckbox"></label>
                                            <button class="sortPopUpClose" data-dropdown-item="" data-sortby-item=""
                                                data-value="manual">
                                                Featured</button>
                                        </div>
                                        ...
                                        <div class="sort-by-radio ">
                                            <input type="checkbox" id="myCheckbox__3" class="t4s-checkbox-wrapper"
                                                name="sort option">
                                            <label for="myCheckbox"></label>
                                            <button class="sortPopUpClose" data-dropdown-item="" data-sortby-item=""
                                        ...
                                        <div class="sort-by-radio ">
                                            <input type="checkbox" id="myCheckbox__4" class="t4s-checkbox-wrapper"
                                                name="sort option">
                                            <label for="myCheckbox"></label>
                                            <button class="sortPopUpClose" data-dropdown-item="" data-sortby-item=""
                                        ...
                                        <div class="sort-by-radio ">
                                            <input type="checkbox" id="myCheckbox__5" class="t4s-checkbox-wrapper"
                                                name="sort option">
                                            <label for="myCheckbox"></label>
                                            <button class="sortPopUpClose" data-dropdown-item="" data-sortby-item=""
                                        ...
                                        <div class="sort-by-radio ">
                                            <input type="checkbox" id="myCheckbox__6" class="t4s-checkbox-wrapper"
                                                name="sort option">
                                            <label for="myCheckbox"></label>
                                            <button class="sortPopUpClose" data-dropdown-item="" data-sortby-item=""
                                        ...
                                        <div class="sort-by-radio ">
                                            <input type="checkbox" id="myCheckbox__7" class="t4s-checkbox-wrapper"
                                                name="sort option">
                                            <label for="myCheckbox"></label>
                                            <button class="sortPopUpClose" data-dropdown-item="" data-sortby-item=""
                                        ...
                                        <div class="sort-by-radio ">
                                            <input type="checkbox" id="myCheckbox__8" class="t4s-checkbox-wrapper"
                                                name="sort option">
                                            <label for="myCheckbox"></label>
                                            <button class="sortPopUpClose" data-dropdown-item="" data-sortby-item=""
                    ...
                    <div class="t4s-row">
                        <div class="t4s-col-item t4s-col-12 t4s-main-area t4s-main-collection-page is--enabled">
                            <div
                                class="t4s_box_pr_grid t4s-products  t4s-text-default t4s_ratio1_1  t4s_position_default t4s_contain t4s-row  t4s-justify-content-center t4s-row-cols-2 t4s-row-cols-md-3 t4s-row-cols-lg-4 t4s-gx-md-30 t4s-gy-md-10 t4s-gx-15 t4s-gy-4">
                                ...
                                <?php while ($products = mysqli_fetch_array($ret)) { ?>
                                    ...
                                    <div class="t4s-product t4s-pr-grid t4s-pr-style1 t4s-pr-8195757703414 t4s-col-item is-t4s-pr-created"
                                        id="8195757703414" style="position: relative;">
                                            ...
                                            <div class="t4s-product-inner t4s-pr t4s-oh">
                                                <div class="t4s-product-img t4s_ratio" data-style="--aspect-ratioapt: 1.0">
                                                    ...
                                                    <img class="t4s-product-main-img"
                                                        src="admin/productimages/<?php echo htmlentities($products['id']); ?>/<?php echo htmlentities($products['productImage1']); ?>"
                                                        width="800" height="800"
                                                        alt="Buy <?php echo htmlentities($row['productName']); ?> Decor We online | Beautiful Cocktail Tools Set to choose from">

                                                    <span class="lazyloadt4s-loader"></span>
                                                    <noscript><img class="t4s-product-main-img" loading="lazy"
                                                            src="cdn/shop/files/BN1A1188.jpg?v=1697644854&width=600"
                                                            alt="Buy Evara Floral Bedsheet - Cream Online in India | Bedsheets on Vaaree"></noscript>
                                                </div>
                                                <div data-product-badge="" data-sort="sale,new,soldout,preOrder,custom"
                                                    class="t4s-product-badge"><span data-badge-sale=""
                                                        class="t4s-badge-item t4s-badge-sale">-30%</span></div>
                                                <div class="t4s-product-btns">
                                                </div>
                                                <div class="t4s-product-btns2">
                                                </div><a data-pr-href="" class="t4s-full-width-link is--href-replaced"
                                                    href="products.php?pid=<?= $products['id'] ?>"
                                            ...
                                            <div class="t4s-product-info">
                                                <div class="t4s-product-info__inner">
                                                    <h3 class="t4s-product-title"><a data-pr-href=""
                                                            href="products.php?pid=<?= $products['id'] ?>"
                                                            class="is--href-replaced"><?= $products['productName']; ?></a>
                                                    </h3>
                                                    ...
                                                    <?php if ($products['productAvailability'] == 'In Stock') { ?>
                                                        <div class="text-center">
                                                            <a href="account/cart.php?pid=<?php echo htmlentities($products['id']) ?>&action=cart"
                                                ...
                                                t4s-btn-effect-sweep-to-top t4s-btn-loading__svg"
                                                    ...
                                                    <?php } ?>
                                                    <div class="delivery_date_wrapper t4s-d-none"
                                                        id="delivery_date_wrapper_8195757703414">
                                                        <span class="delivery_date_section">Delivery by</span>
                                                        <span id="shipping-estimate-date" class="delivery_date"></span>
                                                    </div>
                                                    <link href="cdn/shop/t/130/assets/delivery_date_fbv.css"
                                                        rel="stylesheet" type="text/css" media="all">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="t4s-row t4s-prs-footer t4s-has-btn-infinite t4s-text-center">
                                <div class="t4s-pagination-wrapper t4s-w-100 hdt-reveal--offscreen">
                                    <a href="collections.php?cid=<?= $_GET['cid']; ?>&page=<?= $page + 1; ?>"
                                        ...
                                        <div class="t4s-loading__spinner t4s-dn">
                                            <svg width="16" height="16" aria-hidden="true" focusable="false"
                                                role="presentation" class="t4s-svg__spinner" viewBox="0 0 66 66"
