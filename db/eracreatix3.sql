...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2024 at 02:03 PM
...
CREATE TABLE `products` (
  ...
  `size` varchar(255) DEFAULT NULL,
  `color` varchar(255) DEFAULT NULL,
  `productHighlight` varchar(2000) DEFAULT '''No highlight available''',
  `additionalInfo` varchar(2000) DEFAULT '''no info available''',
  `productrefundandExchange` varchar(2000) DEFAULT '''no refund policy''',
