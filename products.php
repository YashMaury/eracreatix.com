                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="t4s-product-form__buttons" style="--pr-btn-round:40px;">
                                                            <div class="t4s-d- t4s-flex-wrap">
                                                                ...
                                                                <button id="add_to_cart" style="min-width: unset;border: 3px solid #099bb4" type="submit" class="t4s-product-form__submit t4s-btn t4s-btn-style-default t4s-w-100 t4s-justify-content-center  t4s-btn-effect-sweep-to-top t4s-btn-loading__svg">
                                                                    Add to Cart
                                                                </button>
                                                ...
                                                <div class="delivery-fbv-container">
                                                    ...
                                                    <div class="delivery-info-fbv " id="delivery_date_wrapper_fbv_8357838979318" style="display:none">
                                                        ...
                                                        <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="thundering-icon">
                                                            <path d="M6.85918 1L0.90918 9.4H5.80918L4.75918 15L10.7092 6.6H5.80918L6.85918 1Z" fill="#099bb4" stroke="#262727" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"></path>
                                                        </svg>
